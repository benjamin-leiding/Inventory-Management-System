...
import { IconArrowBack, IconCube, IconFile3d, IconUserCheck, IconUserShare } from "@tabler/icons-react"
import { useState } from "react"
import { useAppSelector } from "../Hooks"
import { RentContract } from "../Models/RentContract"
import { selectRentContracts } from "../state/RentContractState"
import { isDateInPast, sortRentContractsByExpires } from "./AllRentContracts"

export const OwnRentContracts = () => {
    ...
    return <div style={{padding: "15px"}}>
        ...
        {contractState.ownContracts.length === 0 && <Text>You currently dont have any items borrowed</Text>}

        {openedScreen === "Contracts" && sortRentContractsByExpires(contractState.ownContracts).map(contract => {
